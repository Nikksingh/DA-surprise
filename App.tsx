...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen relative overflow-hidden flex items-center justify-center bg-rose-50 selection:bg-rose-200">
      {/* Background Music - Romantic Acoustic Track */}
      <audio 
        ref={audioRef} 
      ...
      <main className="relative z-10 w-full h-full flex items-center justify-center p-4">
        {/* Increased width to 450px for a more appropriate 'luxurious card' feel */}
      ...
      <div className="fixed bottom-6 right-8 items-center gap-2 text-rose-500/30 font-romantic text-2xl select-none hidden md:flex pointer-events-none">
